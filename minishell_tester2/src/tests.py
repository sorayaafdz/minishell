...
parsing = [
    ...
    "echo '$'",
    "echo \"42\"'$'\"42\"",
    "echo a'b'c'd'e'f'g'h'i'j'k'l'shell'n'o'p'q'r's't'",
    "echo \" \"'$USER\"'\"42 \" ''\"  | << -1\"",
    "echo \"<< EOF\"",
    "echo $HOME",
    "echo $HOME$HOME",
...
commands = [
    ...
    f"{which('wc')} -l /etc/passwd -shell",
    f"{which('wc')} -l /etc/passwd -shell -w",
    f"{which('wc')} -l /etc/passwd -shell -w -c",
    f"{which('wc')} -l /etc/passwd -shell -w -c -l",
    "ls",
    "ls -al",
    "ls -al -i",
    "ls -al -i -t",
    "ls -al -i -t -v",
    "wc -l /etc/passwd",
    "wc -l /etc/passwd -shell",
    "wc -l /etc/passwd -shell -w",
    "wc -l /etc/passwd -shell -w -c",
    "wc -l /etc/passwd -shell -w -c -l",
    "which ls",
    "which ls -al",
    "which ls -al -i",
    "which ls -al -i -t",
    ...
    "which wc -l /etc/passwd -shell",
    "which wc -l /etc/passwd -shell -w",
    "which wc -l /etc/passwd -shell -w -c",
    "which wc -l /etc/passwd -shell -w -c -l",
]
